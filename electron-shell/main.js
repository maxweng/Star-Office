...
const rawBackendPort = Number(process.env.STAR_BACKEND_PORT || 18790);
const BACKEND_PORT = Number.isFinite(rawBackendPort) && rawBackendPort > 0 ? rawBackendPort : 18790;
