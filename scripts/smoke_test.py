...
Usage:
  python3 scripts/smoke_test.py --base-url http://127.0.0.1:18790
...
def main() -> int:
    ...
    ap.add_argument("--base-url", default="http://127.0.0.1:18790", help="Base URL of Star Office UI service")
    args = ap.parse_args()
